...
namespace Okra.Tests.Navigation
{
    ...
    public class NavigationManagerFixture
    {
        ...
        {
            MockNavigationTarget navigationTarget = new MockNavigationTarget();
            INavigationManager navigationManager = CreateNavigationManager(navigationTarget: navigationTarget);

            navigationManager.NavigateTo("Page 1");
            MockPage currentPage = navigationTarget.NavigatedPages.Cast<MockPage>().LastOrDefault();
        ...
        public void GoBack_CallsNavigatingFromOnPreviousPage()
        {
            ...
            navigationManager.NavigateTo("Page 2");
            MockNavigationAwarePage currentPage = (MockNavigationAwarePage)navigationTarget.NavigatedPages.Last();
        ...
        public async Task RestoreNavigationStack_NavigatesToHomePageIfNoPreviousNavigationStack()
        {
...

            {
                ...
                INavigationManager navigationManager = CreateNavigationManager(navigationTarget: navigationTarget, lifetimeManager: lifetimeManager, storageManager: storageManager);
                navigationManager.NavigationStorageType = NavigationStorageType.Local;
                navigationManager.HomePageName = "Home";
        ...
        [TestMethod]
        public async Task RestoreNavigationStack_RaisesNavigatedToEvent()
        {
            IStorageManager storageManager = new MockStorageManager();
...

            {
                ...
                // Check that the NavigatedTo event has been raised

                Assert.AreEqual(1, navigationEventArgs.Count);
                Assert.AreEqual("Page 2", navigationEventArgs[0].Page.PageName);
                Assert.AreEqual(NavigationMode.Refresh, navigationEventArgs[0].NavigationMode);
            }
        }
        ...
        [TestMethod]
        public async Task RestoreNavigationStack_CallsNavigatingToOnRestoredPage()
        {
            IStorageManager storageManager = new MockStorageManager();
        ...
        [TestMethod]
        public void CanGoBackChanged_IsNotCalledWhenFirstPageNavigated()
        {
            INavigationManager navigationManager = CreateNavigationManager();
        ...
        [TestMethod]
        public void CanGoBackChanged_IsCalledWhenSecondPageNavigated()
        {
            INavigationManager navigationManager = CreateNavigationManager();
        ...
        [TestMethod]
        public void CanGoBackChanged_IsNotCalledWhenThirdPageNavigated()
        {
            INavigationManager navigationManager = CreateNavigationManager();
        ...
        [TestMethod]
        public void CanGoBackChanged_IsNotCalledWhenThirdPageNavigatedThenBack()
        {
            INavigationManager navigationManager = CreateNavigationManager();
        ...
        [TestMethod]
        public void CanGoBackChanged_IsCalledWhenSecondPageNavigatedThenBack()
        {
            INavigationManager navigationManager = CreateNavigationManager();
